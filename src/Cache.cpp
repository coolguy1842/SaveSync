...
std::shared_ptr<File> Cache::openCacheFile(u32 flags) { return openFile(DATA_DIRECTORY "/cache", flags); }
std::shared_ptr<File> Cache::openMapFile(u32 flags) { return openFile(DATA_DIRECTORY "/cache.map", flags); }
